...
var gameSuccess = function gameSuccess() {
  $('.gameBoard').show();
  $('#reset').show();
  $('#history').show();
};
...
var movesLogged = function movesLogged(data) {
  console.log(data);
};

var movesNotLogged = function movesNotLogged(error) {
  console.log(error);
};
...
var getFail = function getFail(error) {
  console.error(error);
};
...
module.exports = {
  ...
  movesLogged: movesLogged,
  movesNotLogged: movesNotLogged,
...
var userMoves = function userMoves(index, value, over) {
...
var updateGame = function updateGame(index, value, over) {
  api.userMoves(index, value, over).then(ui.movesLogged).catch(ui.movesNotLogged);
};

var newGame = function newGame() {
  event.preventDefault();
  api.game().then(ui.onNewGameSuccess).catch(ui.onNewGameFailure);
};

var pastGames = function pastGames(event) {
  event.preventDefault();
  api.gameHistory().then(ui.getSuccess).catch(ui.getFail);
};
